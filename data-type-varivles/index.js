//    printing the counting usig the do while loop
let i=1;
do{
    console.log(i);
    i++;
...
//    printing the counting using the for loop 
for(let i=1; i<=10 ; i++){
 console.log(i);
}
...
let marks = 8598094858459840584858448355885845845884095348584095948509409485845984598;
console.log(marks);
marks ;
console.log(marks);
